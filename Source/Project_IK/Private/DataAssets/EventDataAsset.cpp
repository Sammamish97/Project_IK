...
FEventData UEventDataAsset::GetActiveSkillDataRandomly(bool only_positive)
{
	...
	if (only_positive)
	{
		rand_idx = FMath::RandRange(4, event_type_array.Num() - 1);
	}
	else
	{
		rand_idx = FMath::RandRange(0, event_type_array.Num() - 1);
	}
