...
public:
	...
	TArray<TPair<ERuneSetType, TArray<int32>>> FigureOutRuneSet(const TArray<FRuneData>& rune_slots);
private:
	TOptional<TPair<ERuneSetType, TArray<int32>>> FigureOutHexagonSet(const TArray<FRuneData>& rune_slot);
	TOptional<TPair<ERuneSetType, TArray<int32>>> FigureOutTriangleSet(const TArray<FRuneData>& rune_slots, TArray<int32>& indices, TArray<int32>& inv_indices);
	TArray<TPair<ERuneSetType, TArray<int32>>> FigureOutEdgeSet(const TArray<FRuneData>& rune_slot);
