...
Summary : Header file for a global buff that upgrades hero Beta.
...
#include "GB_UpgradeBeta.generated.h"

/**
 * 
 */
UCLASS()
class PROJECT_IK_API UGB_UpgradeBeta : public UGlobalBuffLogicBase
{
	GENERATED_BODY()
public:
