...
public:
	...
	FPassiveSkillData GetPassiveSkillDataRandomly(UWorld* world, ERarity weight_rarity = ERarity::Common);
	TArray<FPassiveSkillData> GetPassiveSkillDataByRarity(int32 n, UWorld* world, ERarity rarity = ERarity::Common);
	TArray<FPassiveSkillData> GetUniquePassiveSkillDataRandomly(int32 n, UWorld* world, ERarity weight_rarity = ERarity::Common);
